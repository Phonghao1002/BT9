...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateCountriesData() {
        ...
        countriesModel = new CountriesModel();
        countriesModel.setId(1);
        countriesModel.setName("Võ Văn Thành");
        countriesModel.setImage(R.drawable.ute);
        countriesModel.setPopulation("1811505310347");
        countriesData.add(countriesModel);

        //country 2
        countriesModel = new CountriesModel();
        countriesModel.setId(2);
        countriesModel.setName("Phạm Phong Hào");
        countriesModel.setImage(R.drawable.cute);

        countriesModel.setPopulation("1811505310311");
        countriesData.add(countriesModel);

        //country 3
        countriesModel = new CountriesModel();
        countriesModel.setId(1);
        countriesModel.setName("Lê Anh Tuấn");
        countriesModel.setImage(R.drawable.dt);
        ...
        countriesModel.setImage(R.drawable.vt);
        countriesModel.setPopulation("1811505310349");
        countriesData.add(countriesModel);
    }
